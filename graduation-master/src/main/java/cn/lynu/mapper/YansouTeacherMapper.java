...
public interface YansouTeacherMapper {
    ...
    int deleteYansouTeacherBytid(String teacherId);
    int updateByTeacherId(YansouTeacher yansouTeacher);
    List<YansouTeacher> selectByYansouId(@Param("yansouteamId") Integer yansouteamId);
}