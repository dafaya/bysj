...
public interface StudentMapper {
	...
	int updateByPrimaryKeyPNull(Student record);

	List<Student> getStudentByTeacherId3();

	int updateStudentTeamId(@Param("studentId")String studentId,@Param("yansouTeamId")String yansouTeamId);

	List<Student> findStudentXzpfByYansouId(Integer yansouTeamId);
}